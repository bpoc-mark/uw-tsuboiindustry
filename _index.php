			...
			<section class="sect_1">
				<div class="wrapper">
					...
					<div class="scroll_wrap">
						<a href="javascript:void(0)" class="scroll_wrap--btn">
							Scroll Down
						...
						<div class="row">
							<div class="col">
								<ul class="about--wrap">
									...
									<li class="about_item">
										<a href="/company/environment-policy/" class="about_item--link">
											<p>
												<span>03</span>
												環境方針
											</p>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col">
								...
								<ul class="post">
								<?php query_posts('order=DESC&posts_per_page=3&post_type=news'); ?>
								<?php if ( have_posts() ) :	?>
